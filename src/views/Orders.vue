    ...
    <div class="bg-fa of">
        <section id="index" class="container">
            ...
            <el-table :data="list" border style="width: 100%">
                ...
                <el-table-column prop="orderNo" label="订单编号" width="230" align="center"></el-table-column>
                <el-table-column prop="title" label="订单标题" align="center"></el-table-column>
                <el-table-column prop="totalFee" label="订单金额" align="center">
                    <template slot-scope="scope">
                        {{scope.row.totalFee / 100}} 元
                    </template>
                </el-table-column>
                <el-table-column prop="paymentType" label="支付方式" align="center"></el-table-column>
